...
```text
โจทย์ต้องการราคาสุทธิหลังลดราคา
Input : สถานะ Member จำนวนสินค้า ราคาสินค้าแต่ละชิ้น
Output : ราคาสุทธิ
Constaints : input แยกบรรทัด และ รับราคาตามจำนวน
```
...
```text
Step1 : รับค่าข้อมูลเข้ามา
Step2 : เช็คว่าเป็น Member หรือไม่ ถ้าใช่ให้เอาราคามา *0.95 ถ้าไม่ให้เช็คว่าราคารวมเกิน 500 หรือไม่ ถ้าไม่ก็ให้ราคาเท่าเดิม ถ้าเกินก็เอาราคามา *0.97 
Step3 : Output ราคา
```
...
```text
เหมือนกันแผนแรก รับค่าเข้ามาและเช็ค Member status ก่อน แล้วจึง operate ราคา และแสดง output
```
...
```text
เช็คว่าโค้ดสามารถทำงานได้ถูกต้อง
```
...
```text
เช็คว่าถ้าไม่เป้นสมาขิกและราคาไม่ถึงจะให้ output  5 ถูกหรือไม่
```
