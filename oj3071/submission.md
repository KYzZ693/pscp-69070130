...
```text
Input : ตัวเลขเริ่มต้น ตัวเลขสุดท้าย ตัวหาร เศษ
Output : จำนวนตัวเลขใน range ที่ระบุที่หารแล้วได้เศษตามที่ระบุ
Constraints : ตัวเลขสุดท้ายจะมากกว่าเลขเริ่มเสมอ และเศษจะน้อยกว่าตัวหารเสมอ
```
...
```text
step1 : รับค่าทั้งหมดเข้ามาคนละบรรทัด
step2 : loop ใน range ที่กำหนด
step3 : นำเลขมาหารกับเลขที่ระบุและเมื่อเจอเลขที่หารแล้วได้เศษที่ระบุให้ count+1
step4 : output print ออกมา
```
...
```text
เหมือนกับวิธีแรกรับค่ามาเข้า loop และตรวจสอบ
```
