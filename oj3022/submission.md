...
```text
input : ค่าอุณหภูมิ ชนิดของอุณหภูมิที่รับมา อุณหภูมิที่ต้องการแปลง
output : ค่าของอุณหภูมิตามชนิดที่ระบุ
constraints : ต้องแปลงค่าที่รับมาให้เป็นชนิดอุณภูมิที่ต้องการ
```
...
```text
เริ่มจากรับค่า อุณหภูมิเริ่มต้น และ อุณหภูมิที่ต้องการ 
ต่อมาให้เช็คอุณหภูมิเริ่มต้นว่าใช่ C หรือไม่ 
ถ้าใช่ให้คำนวณเป็นอุณหภูมิที่ต้องการ
ถ้าไม่ให้คำนวณเป็นอุณหภูมิในหน่วย C ก่อน แล้วค่อยคำนวณเป็นอุณหภูมิที่ต้องการ
```
...
```text
เป็นวิธีเดียวกับวิธีแรกด้วยการรับ input เข้ามาละเช็คค่าอุหภูมิก่อน ถ้าเป็น C ก็คำนวณเลย ถ้าไม่ให้แปลงเป็น C ก้อนค่อยคำนวณ และแสดงออกมา
```
...
```text
เพื่อเช็คว่าสามารถแปลงได้ถูกต้อง
```
...
```text
เช็คว่าสามารถแปลงกลับเป็น C ได้ถูกต้อง
```
...
```text
เช็คว่าสามารถเปลี่ยนค่าอุณหภูมิข้ามขั้นได้ไหม
```
