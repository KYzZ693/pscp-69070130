...
```text
input : ผลรวมคะแนนของสามคน(?) คะแนนสูงสุด โดยรับเป็นจำนวนจริง
output : Not surprising ถ้าสูงสุดและต่ำสุดห่างกันไม่เกิน 2 และ Surprising ถ้าสูงสุดและต่ำสุดห่างกันเกิน 2 
constraints : ต้องหาค่าต่ำสุดและเปรียบเทียบกับค่าสูงสุดที่ input มา
```
...
```text
เริ่มจากรับค่าคะแนนรวมกับคะแนนสูงสุดมาก่อน
ต่อมาให้นำเอาคะแนนสูงสุดหักออกจากคะแนนรวม และ นำมาหาเลขที่น้อยที่สุดด้วยการวนลูปหา
และแสดงผล Not surprising ถ้าสูงสุดและต่ำสุดห่างกันไม่เกิน 2 และ Surprising ถ้าสูงสุดและต่ำสุดห่างกันเกิน 2 
```
...
```text
เป็นวิธีเดียวกับวิธีแรกคือรับค่ามาและวนลูปเพื่อหาค่าต่ำที่สุดที่ไม่เกินค่าสูงสุด และแสดงผล Not surprising หรือ Surprising
```
...
```text
เพื่อเช็คในเคสที่คะแนนรวมเป็น 0 ว่าจะไม่ผิด
```
...
```text
เพื่อเช็คในเคสที่ได้คะแนนเต็มหมดว่าจะไม่ผิด
```
...
```text
เพื่อเช็คว่าสามารถรันเลขทศนิยมได้
```
