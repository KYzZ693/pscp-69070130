...
```text
input : RGB สองชุด ในชุดคั่นด้วยเว้นวรรค คั่นชุดด้วยเว้นบรรทัด
output : RGB ที่ mixed รวมกันแล้ว
constraints : มีเว้นบรรทัด และคั่นด้วยช่องว่างระหว่างเลข
```
...
```text
รับค่ามาและแปลงเป็น int ด้วย map และเลขแต่ละหลักมารวมกันแล้วหาร 2 แบบไม่เอาเศษ
```
...
```text
เหมือนวิธีแรกเป๊ะๆ รับค่า แปลงเป็น int แต่ละตัวรวมกันหาร2
```
