...
```text
input : แม่สี 2 สี
output : สีที่ผสมกันจาก input
constraints : สีที่ออกมามีแค่ Orange , Green , Violet , Error เท่านั้น
```
...
```text
Step 1 : รับค่าแม่งสีมา 2 สี
Step2 : ใช้ match case ในการจับคู่สีว่าจะได้สีอะไร
Step3 : output สีที่ได้
```
...
```text
ใช้ list เพื่อเก็บค่าแม่สีที่ผสมกันของสีนั้นๆ และเช็คสีที่ input ว่าตรงกันหรือไม่
```
...
```text
เพราะจะได้เทสแบบธรรมดาให้รู้ว่าโปรแกรมสามารถรันได้ปกติ
```
...
```text
เพราะจะเช็คว่าถ้าสีซ้ำกันจะเป็นอย่างไร
```
...
```text
เพื่อเช็คว่าถ้าเป็นสีที่ไม่ใช่แม่สีซ้ำกันจะเป็นอย่างไร
```
...
```text
ให้คำใบ้เรื่อง list ของสี
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียน process ทุกอย่าง เพื่อนแค่บอกว่าใช้ list จะดูเท่กว่า
```
