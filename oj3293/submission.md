...
```text
Input : รับ str มา 5 บรรทัด
Output : กรอบ * ที่อยู่รอบของ input ทั้งหมดเป็นกรอบใหญ่
Constraints : ขอบจะต้องอยู่นอกสุดขนากอิงจาก input ที่ยาวที่สุด
```
...
```text
วนลูป 5 รอบเพื่อเพิ่ม input เข้า list แล้วหาจำนวนตัวที่สูงที่สุด แล้ว output กรอบบน ตามด้วยแต่ละบรรทัด และกรอบล่าง
```
...
```text
เหมือนกับวิธีแรก เพิ่ม input เข้า list หาจำนวนตัวที่มากที่สุดแล้ว output frame ออกมา
```
...
```text
เช็คว่าถ้าบรรทัดไม่เท่ากันจะสร้างกรอบได้ถูกต้อง
```
