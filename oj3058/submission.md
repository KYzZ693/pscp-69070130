...
```text
โจกย์ต้องการหาจำนวนอิฐก้อนเล็กที่ใช้น้อยที่สุด
Input : อิฐเล็กที่มี อิฐใหญ่ที่มี ระยะที่ต้องการ
Output : อิฐเล็กที่ต้องใช้หรือ -1 ถ้าอิฐเล็กไม่พอ
Constraints : input รับเป็นจำนวนเต็มบรรทัดละ 1 อย่าง
```
...
```text
Step 1 : รับจำนวนเต็มของ อิฐเล็ก ใหญ่ และ ระยะทางรวม
Step 2 : เช็คว่าอิฐมีเพียงพอหรือไม่ทั้งใหญ่และเล็ก ถ้าไม่พอให้ output -1
Step 3 :  หากอิฐเพียงพอให้ output ค่าอิฐเล็กที่ต้องใช้
```
...
```text
วิธีสุดท้ายเหมือนวิธีแรกคือรับค่ามาและเปรียบเทียบว่ามีอิฐพอหรือไม่ ถ้าพอก็แสดงผลอิฐเล็กที่ต้องใช้ ถ้าไม่พอก็ -1
```
...
```text
เพื่อตรวจสอบเคสที่มีอิฐใหญ่พอแต่อิฐเล็กไม่พอ
```
...
```text
เพื่อตรวจสอบเคสที่พอมีพอแต่มีอิฐใหญ่น้อย
```
...
```text
เพื่อตรวจสอบว่าระบบนับขาดไม่ผิดปกติ
```
