...
```text
โจทย์ให้หาเลขที่หาร 10 ลงตัวที่มาหลังเลขที่ input
Input : เลขจำนวนเต็ม
Output : เลขทั้งหมดที่หาร 10 ลงตัว ที่มาหลังเลข input
Constraints : เลขทั้งหมดที่หาร 10 ลงตัวโดยคั่นด้วยช่องว่าง
```
...
```text
step1 : รับจำนวนเต็ม
step2 : เข้า reverse loop  เพื่อหาเลขที่หาร 10 ลงตัวจากมากไปน้อย
step3 : แสดงผลออก โดยเว้นช่องว่างไว้หลังสุดทุกครั้ง แต่ถ้าถึง 0 แล้วไม่ต้องเว้น
```
...
```text
ใช้วิธีเดียวกับแผนแรก โดยรับค่าเข้ามาละนำมาเข้า loop แล้วนำไปหาร
```
...
```text
เช็คว่าค่าจะออกมาถูกต้องตั้งแต่ตัวแรกจนถึง 0
```
...
```text
ทดสอบว่าถ้า input ไม่ได้หาร 10 ลงตัวจะยังรันถูกมั้ย
```
