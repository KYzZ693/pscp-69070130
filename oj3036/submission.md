...
```text
โจทย์ให้หาวิธีที่สั้นที่สุดจากจุดที่อยู่จนถึงจุดที่ 1 
Input : จุดที่อยู่
Output : ประตูที่พังจนถึงห้องที่ 1
Constraints : input range คือ จะไม่เกิน 100000
```
...
```text
step1 : รับค่าจุดที่อยู่
step2 : นำเข้า loop เพื่อที่จะเช็คว่าจุดที่เราอยู่อยู่แถวที่เท่าไหร่
step3 : เข้า condition ถ้าแถวเป็นเลขคู่และจุดที่รับ input มาเป็นคู่ หรือ แถวคี่ ห้องคี่ ให้แสดงผลออกมาเป็น (แถว-1)*2 เคสอื่นให้ ((แถว-1)*2-1)
```
...
```text
วิธีเดียวกับวิธีแรก รับค่า input เข้ามาละก็วนลูปเพื่อหาแถว ละเอาแถวกับเลขห้องมาเปรียบเทียบว่าจะแสดงผลอะไร
```
...
```text
เทสค่าว่าระบบหาแถวและ operate ปกติ
```
...
```text
เทสค่าว่าถ้ามากแล้วจะยังรันได้
```
