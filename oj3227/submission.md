...
```text
input : สัญลักษณ์ไพ่
output : ชื่อเต็มของไพ่ใบนั้น
constraints : สัญลักษณ์หรือเลขจะติดกับชื่อ clan
```
...
```text
step 1 : สร้าง dict ของชื่อไพ่พิเศษ และ dict ของ clan
step 2 : รับ input เข้ามาและเอาตัวสุดท้ายของสัญลักษณ์ไปดึงค่าใน clan ออกมา
step 3 : เช็คตัวแรกถึงตัวก่อนสุดท้าย เพื่อดูว่ามีใน dict พิเศษหรือไม่ ถ้ามีก็ดึงชื่อมา ถ้าไม่มีก็ไม่ต้องดึง ให้เพิ่มไปในชื่อได้เลย
step 4 : output ชื่อไพ่เต็มๆออกมา
```
...
```text
เหมือนกันแผนแรกคือสร้าง dict สัญลักษณ์พิเศษ และ dict clan มา เอาชื่อ clan ใส่ เช็คตัวอักษรหรือเลขและใส่ แล้ว output
```
...
```text
เพื่อเช็คว่าต่อให้พิมพ์ไม่เหมือนกันหรือไม่ใช่พิมพ์ใหญ่หมดก็สามารถรันได้
```
...
```text
เพื่อเช็คว่าสามารถรันชื่อที่เป็นตัวเลขได้
```
...
```text
เพื่อเช็คว่ารันเลขสองหลักได้หรือไม่
```
