...
```text
input : เลขที่ถูกรางวัล กับ เลขที่มี
output : รางวัลที่ได้ เป็นจำนวนเงิน
constraints: เวลาเช็คต้องเช็คทั้งตัวอักษรและตัวเลข
```
...
```text
step1 : รับ input ทั้งสองค่าเข้ามาและแยกตัวเลขกับตัวอักษรออก
step2 : เช็คตัวอักษรว่าตรงกันหรือไม่ถ้าตรงให้ทำต่อ ถ้าไม่ตรงให้ไปอีกเงื่อนไขนึง
step3 : เช็คตัวเลขและเพิ่มเงินรางวัล
step4 : output เงินรางวัล
```
...
```text
เหมือนแผนแรก รับค่าเข้ามา เช็คตัวอักษร เช็คเลข และ output เงินรางวัล
```
...
```text
เช็คตัวอักษรเหมือนเลขไม่เหมือน
```
