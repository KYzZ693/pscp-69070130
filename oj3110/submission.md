...
```text
โจทย์ระบุให้หาราคาที่รวมกับน้ำหนักแล้ว หรือคือราคาสุทธิ
Input : ต้นทาง ปลายทางในบรรทัดเดียวกันและน้ำหนักพัสดุอีก 1 บรรทัด
Output : ราคารวมสุทธิ์
Constraints : ต้นทาง ปลายทางต้องอยู่ในบรรทัดเดียวกัน
```
...
```text
Step1 : รับค่า input เข้ามา
Step2 : เอาต้นทางปลายไปเช็คในข้อมูลว่ามีหรือไม่ ถ้ามีให้เอาราคาไปรวมกันน้ำหนักที่คูณราคาแล้ว ถ้าไม่ให้ output 'Error'
```
...
```text
เหมือนแผนแรกคือรับค่าเข้ามาและเช็คค่า
```
...
```text
เช็คค่าที่มีต้นทาง และ ปลายทางตามกำหนด
```
...
```text
เช็คค่าที่มีต้นทาง แต่ไม่มีปลายทางที่กำหนด
```
...
```text
เช็คค่าที่ไม่มีต้นทางที่กำหนด แต่มีปลายทาง
```
