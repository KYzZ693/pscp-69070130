...
```text
[LEARNING LOGS] ของขวัญและขโมย - OJ3135
```
...
```text
โจทย์ต้องการจำนวนรอบที่จะวนโดนคนแรก หรือ โดนขโมย
Input : จำนวนคน ระยะที่ส่งให้ ที่ของโจร
Output : จำนวนคนที่ได้จับของขวัญ
Constraint : คนจะนั่งเป็นวงกลม
```
...
```text
step1 : รับค่าเข้ามา
step2 : เช็คว่าถ้าขโมยเป็นคนที่ 1 ให้ output 1 เลย
step3 : ถ้าไม่ให้ loop จนถึง หรม ของจำนวคนและจำนวนที่ข้าม
step4 : เช็คว่าเท่ากับโจรหรือคนแรกหรือไม่ ถ้าใช่ก็ output จำนวนคนได้เลย
```
...
```text
รับค่าเข้ามาและเช็คว่าขโมยเป็นคนที่ 1 หรือไม่ ถ้าใช่ก็ output ถ้าไม่ก็ไปวนลูปเพื่อหาจำนวนคนที่ถือ และ output
```
...
```text
เช็คเคสที่ไม่เจอโจรจนกลับมาเจอคนแรก
```
