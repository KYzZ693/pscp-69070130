...
```text
Step 1: ใช้ if condition เช็คราคาของค่าบริการและเพิ่มไปตามนั้นและรวมกับ vat และ output ออกมา
```
...
```
เหมือนกัน เพราะเห็นวิธีการทำงานของโปรแกรมและเป็นวิธีที่ปลอดภัย
```
