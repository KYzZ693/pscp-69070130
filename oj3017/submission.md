...
```text
input : ราคาอาหารเดี่ยวๆ
output : ราคารวมที่รวมค่าบริการ 10% และ vat อีก 7% เป็นทศนิยม 2 ตำแหน่ง
constrainsts : ราคาที่รวมจะต้องรวมค่าบริการก่อนถึงจะไปรวม vat
```
...
```text
Step 1 : รับค่าราคาเปล่าๆมาก่อน
step2 : ใช้ if condition เช็คราคาของค่าบริการและเพิ่มไปตามนั้นและรวมกับ vat และ output ออกมา 
```
...
```text
เหมือนกัน ใช้ codition เพื่อที่จะเช็คว่าราคาเกินหรือต่ำเกินหรือไม่ และคำนวณราคา service charge และ vat แล้ว
```
...
```text
เพราะจะได้เช็คว่าค่าบริการเมื่อต่ำกว่า 50 จะออกมาเป็น 50 หรือไม่
```
...
```text
เช็คว่าถ้าค่าบริการเกิน 1000 จะออกมาเป็น 1000 หรือไม่
```
...
```text
เพราะจะได้เช็คว่าโปรแกรมจะทำงานได้ถูกต้องหรือไม่
```
