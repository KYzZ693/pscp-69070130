...
```text
Input : คำศัพท์
Output : ตัวอักษรสระพร้อมจำนวนตัวที่มี
Constraints :  ตัวอักษรที่นับมีแค่ A E I O U
```
...
```text
step1 : รับค่าคำศัพท์มาและเปลี่ยนให้เป็นตัวเล็กทั้งหมด
step2 : สร้าง dict ที่ด้านในมีสระไว้
step3 : loop คำศัพท์ที่ input มา และสร้างเงื่อนไขว่าอยู่ใน dict ที่จุสระหรือไม่ ถ้าใช่ให้เพิ่ม values ของสระนั้น ถ้าไม่ให้ไปตัวต่อไป
step4 : loop dict ที่จุสระที่นับเรียบร้อยแล้วแล้วตรวจสอบว่า values ไหนที่เกิน 0 บ้างให้แสดง  
```
...
```text
เหมือนกับวิธีแรก รับคำศัพท์ สร้าง dict เปรียบเทียบและเพิ่มค่าใน dict และแสดงผล
```
...
```text
เพราะมีสระครบ สามารถตรวจสอบการนับได้
```
