...
```text
input : ขนาดแถบ และ ช่องที่อยากรู้ คั่นด้วยช่องว่าง
output :  แถบที่ช่องที่ต้องการหาอยู่
constraints : ขนาดของแถบเพิ่มขึ้นตาม input
```
...
```text
รับค่าเข้ามาแล้วหาแถบแรกก่อน จากนั้นก็เข้า while loop  ให้หาจนกว่าจะเจอว่าอยู่แถบไหน ถ้าเจอก็ให้ break แล้ว output ถ้าไม่ก็ให้ให้เพิ่มตำแหน่งท้ายสุดไปและหาต่อจนกว่าจะเจอ
```
...
```text
เหมือนแผนแรกคือรับ input มาแล้วหาแถบแรก จากนั้นให้ while loop เพื่อหาต่อไป หาเจอก็ break  ออก ถ้ายังก็ให้เพิ่มตำแหน่งสุดท้ายไปจนกว่าจะหาเจอ
```
