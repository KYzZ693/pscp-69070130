...
```
input : ตัวอักษรภาษาอังกฤษ 5 ตัวอักษร
output : input แบบ Reverse
constraints : ต้อง output เป็นพิมพ์เล็กเท่านั้น และ ต้องเรียงตัวอักษรแบบย้อนหลับ
---
...
```text
Step 1: ใช้ for loop ในการ loop ตัวอักษรแบบย้อนกลับ และ ใส่ในตัวแปรที่เตรียมไว้
```
