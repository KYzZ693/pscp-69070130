...
```text
โจทย์อยากหาคำภาษาอังกฤษแบบกลับด้าน
input : คำศัพท์ภาษาอังกฤษ
output : คำศัพท์แบบกลับด้าน
constraints : output ต้องเป็นตัวพิมพ์เล็กเท่านั้น
```
...
```text
step1 : รับค่าคำศัพท์
step2 : ใช้ for loop ในการ loop ตัวอักษรแบบย้อนกลับ และ ใส่ในตัวแปรที่เตรียมไว้
step3 : output ตัวแปรนั้นออกมา
```
...
```text
เหมือนกันกับแผนแรก เพราะว่าเป็นวิธีการที่ง่ายและเห็นกระบวนการของโปรแกรมดี
```
...
```text
เพราะมีการปะปนของตัวอักษรพิมพ์ใหญ่และเล็ก
```
