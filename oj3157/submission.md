...
```text
[LEARNING LOGS] เกมสะสมแต้ม - OJ3157
```
...
```text
โจทย์อยากได้ค่าหลักจากเกินการ operate แล้ว
Input : จำนวนครั้งที่เกิดการคำนวณ และ action
Output : แต้มรวม
Constraints : ถ้า + จะเพิ่มแต้ม 10 ถ้า - จะลดแต้ม 5
```
...
```text
Step1 : รับค่าจำนวนครั้งที่จะ action 
Step 2 : รับค่า action และคิดเลข
Step3 : output ค่าออกมา
```
...
```text
เหมือนวิธีแรก รับค่า คิดเลข แสดงผล
```
...
```text
เช็คว่าสามารถ loop ได้ถูกตามจำนวน
```
