...
```text
input : เดือน วัน
output : ฤดู ณ ตอนนั้น
constraints : หลังวันที่ 21 ของเดือนที่หาร 3 ลงตัว จะมีการเปลี่ยนฤดู
```
...
```text
เริ่มจากรับค่าเดือนและวัน หลังจากนั้นเช็คค่าว่าเดือนนั้นอยู่ในฤดูไหน และเกินวันที่ 21 ของเดือนที่หาร 3 ลงตัวไหม ถ้าใช่ก็แสดงฤดูต่อไป ถ้าไม่ก็ให้แสดงฤดูของเดือนนั้น
```
...
```text
วิธีสุดท้ายเป็นวิธีเดียวกับวิธีแรกโดยรับค่า เดือน และ วันมาเพื่อเช็คว่าอยู่ในช่วงฤดูไหน และแสดงผล
```
...
```text
เช็คว่าแสดงได้ถูกเงื่อนไขของ วันที่ 21 เดืนอที่หาร 3 ลงตัว ได้ถูกต้อง
```
...
```text
เช็คว่าหลังจากวันที่ 21 เดือนที่หาร 3 ลงตัวจะแสดงผลเป็นอีกฤดู
```
...
```text
เช็คว่าจะวนรอบ (หลังจาก fall จะเป็น winter)
```
