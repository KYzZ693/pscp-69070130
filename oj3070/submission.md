...
```text
Input : รับเลข 3 เลขโดยขึ้นบรรทัดใหม่
Output : มีเลขคู่กี่ตัว มีเลขคี่กี่ตัว
Constraints : input จะอยู่ในช่วง [-1000,1000]
```
...
```text
step 1 : วน loop เพื่อรับค่า
step 2 : รับค่าตัวเลข
step 3 : เปรียบเทียบค่าตัวเลข ถ้าหาร 2 ลงตัวให้ even + 1 ถ้า ไม่ให้ odd + 1
step 4 : แสดงผล even และ odd คนละบรรทัด
```
...
```text
วิธีสุดท้ายเหมือนกับวิธีแรกคือวนลูปรับค่าและตรวจสอบไปเรื่อยๆ
```
...
```text
เพื่อตรวจสอบว่าระบบตรวจสอบเลขคี่ปกติ
```
...
```text
เพื่อตรวจสอบว่าระบบตรวจสอบเลขคู่ปกติ
```
...
```text
เพื่อตรวจสอบว่าโปรแกรมสามารถทำงานได้ถูกต้อง
```
