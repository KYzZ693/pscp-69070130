...
```text
[LEARNING LOGS] หาจำนวนเฉพาะ - OJ3160
```
...
```text
โจทย์ต้องการจำนวนเฉพาะที่อยู่ในระยะที่กำหนด
Input : เลขเริ่มต้น และ เลขสุดท้าย
Output : prime number และ จำนวน
Constaints : จำนวนเฉพาะเริ่มต้นที่ 2
```
...
```text
Step1 : รับค่าเลขเริ่มกับเลขจบมา
Step2 : loop ใน range นั้น และก็มี loop เลขตั้งแต่ 2 ถึงเลข ณ ขณะนั้น เป็น nested loop
Step3 : เช็คว่าเลขนั้นหารกับเลขหลักได้หรือไม่  ถ้าหารได้ให้  break ถ้าไม่ให้เพิ่มไปใน  list
Step4 : เช็คว่าใน list มีค่าหรือไม่ ถ้ามีก็ให้ output เลขออกมาด้วย ถ้าไม่ให้ output total prime number ได้เลย
```
...
```text
เหมือนวิธีแรกคือรับค่ามาวนลูปและวนเช็ครายตัว ถ้าหารได้ก็ข้าม ถ้าหารไม่ได้ก็เป็นจำนวนเฉพาะ เพิ่มเข้าใน list และสุดท้ายก็ output เลขและจำนวนออกมา
```
...
```text
เช็คในข้อมูลที่ไม่มีจำนวนเฉพาะ
```
...
```text
เช็คในเคสที่มีจำนวนเฉพาะและเช็ค loop
```
